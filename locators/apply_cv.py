...
class ApplyCVLocators_Page1:
    #ngôn ngữ
    LANGUAGE_DROPDOWN="(//li[@data-name='Language Selector']//button)[1]"
    VIETNAMESE_OPTION = "(//a[@title=' Tiếng Việt'])[1]"
    ENGLISH_OPTION="(//a[@title='English (US)'])[1]"
    # tải CV
    ...
    GIOI_TINH_NAM = "//input[@value='Nam']"
    GIOI_TINH_NU = "//input[@value='Nữ']"
    ...
    SOCIAL_LINK_TEMPLATE = "//a[@href='{url}']"
...
class ApplyCVLocators_Page2:
    ...
    BHXH_CO = "//input[@name='is_social_insurance_no' and @value='true' ]"
    MA_SO_BHXH = "//input[@id='social_insurance_no']"
    BHXH_KHONG = "//input[@name='is_social_insurance_no' and @value='false' ]"
...
class ApplyCVLocators_Page4:
    ...
    NGUOI_THAN_CTGROUP_TEN ="//input[@id='acquaintance_name']"
    ...
    TK_NGAN_HANG_TEN = "//span[@id='select2-bank_name-container']"
    ...
    #hoàn thành
    HOAN_THANH ="//button[text()='Hoàn thành']"